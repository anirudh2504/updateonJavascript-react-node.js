  ...
  return (
    <>
      ...
      <div style={{display:'flex',gap:"2rem",width:"fit-content"}}>
        ...
        <Card title={'Bird Image'} img={img1} description={'This is a bird image sitting on Tree'}/>
        <Card title={'Eye Image'} img={img2} description={'This is a human eye image '}/>
        <Card title={'Tree image'} img={img3} description={'This is a tree image in green land'}/>
      </div>
      <hr />
      <StateHook/>
      <hr />
